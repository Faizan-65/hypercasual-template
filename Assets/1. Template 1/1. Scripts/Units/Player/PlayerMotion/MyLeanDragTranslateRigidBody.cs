...
//[AddComponentMenu(LeanTouch.ComponentPathPrefix + "nmDrag Translate Rigidbody")]
public class MyLeanDragTranslateRigidBody : MonoBehaviour
{
	[HideInInspector] public Vector3 leanCalculatedVelocity;
	[HideInInspector] public float dampenFactor;
